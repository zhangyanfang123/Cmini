...
void Parser::DrawTree(bool outOpt)
{
    ...
    outFile.open("..\\demo\\mid\\Parse.txt",ios::ate);//addddddddddddddddddddddddddddddd
    ...
    for(int i=0;i<data.size();i++)
    {
        ...
        if(temp.back()+1==data[i]->depth){cout<<"_";outFile<<"_";}
        else {cout<<"|_";outFile<<"|_";}
        cout<<"<"<<data[i]->funName<<">";
        outFile<<"<"<<data[i]->funName<<">";
        if(i<data.size()-1 && data[i+1]->depth!=-1) {cout<<endl;outFile<<endl;}
    }
    if(outOpt==1){
